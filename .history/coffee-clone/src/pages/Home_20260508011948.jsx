...
function Marquee() {
  ...
  return (
    <div className="overflow-hidden bg-white py-8 border-y border-gray-100">
      <motion.div
    ...
    <main>
      ...
      <section className="bg-joe-blue text-white px-8 lg:px-20 py-14 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        <div className="flex items-center justify-center">
          <div className="relative flex h-[260px] w-[420px] items-center justify-center">
            <div className="text-center leading-none text-white">
              ...
              <div className="mx-auto mt-4 inline-flex bg-[#24282a] px-7 py-2 text-[18px] font-black uppercase tracking-[0.14em] text-white">
                Coffee Club
              </div>
            </div>
          </div>
