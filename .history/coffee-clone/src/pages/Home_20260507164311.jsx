...
<section
  ...
  style={{
    ...
    background: `
      radial-gradient(circle at 8% 78%, #d08b8d 0%, transparent 31%),
      radial-gradient(circle at 78% 18%, #d9918d 0%, transparent 34%),
      radial-gradient(circle at 54% 58%, #7f74b2 0%, transparent 28%),
      linear-gradient(
        135deg,
        #9186bf 0%,
        #a590c1 42%,
...
>
  {/* HEAVY GRAIN / NOISE */}
  <div
    className="absolute inset-0 pointer-events-none opacity-[0.42] mix-blend-overlay"
    style={{
      backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 240 240' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='n'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.9' numOctaves='4' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23n)' opacity='0.75'/%3E%3C/svg%3E")`,
      backgroundSize: "180px 180px",
    }}
  />

  {/* EXTRA BLUR LAYERS */}
  <div className="absolute -left-20 bottom-0 w-[420px] h-[420px] bg-[#d98f8f] rounded-full blur-[120px] opacity-70" />
  <div className="absolute right-0 top-0 w-[420px] h-[420px] bg-[#e4a09b] rounded-full blur-[140px] opacity-60" />
  <div className="absolute left-1/2 top-1/3 -translate-x-1/2 w-[380px] h-[380px] bg-[#7e72b5] rounded-full blur-[120px] opacity-60" />

  {/* CONTENT */}
  <div className="relative z-10 w-full flex justify-center">
    
    <div className="w-full max-w-[760px] px-6 text-white">
      ...
      >
        ...
        >
          who grow, harvest, invest, and transform.
          moving into feminist futures within coffee.
          profound positive change, courage curiosity,
        ...
        <div className="mt-5 text-center">
          <Link
            to="/shop"
            className="inline-block border-b border-white pb-1 text-[11px] tracking-[0.22em] uppercase font-black hover:opacity-70 transition-opacity"
            style={{
