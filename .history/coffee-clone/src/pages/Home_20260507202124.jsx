...
>
  ...
  <div
    key={p.id}
    className="flex items-center gap-8 border border-gray-100 p-6 hover:shadow-2xl transition-all duration-300 cursor-pointer group min-h-[220px] bg-white"
  >
    {/* IMAGE */}
    <div className="relative w-44 h-44 flex-shrink-0 bg-joe-blue overflow-hidden rounded-sm">
      <img
        src={p.img}
        alt={p.name}
      ...
      <span className="absolute top-2 left-2 bg-joe-dark text-white text-[10px] font-bold px-2 py-1 uppercase">
        Sold out
      </span>

      <span className="absolute top-10 left-2 bg-joe-blue text-white text-[10px] font-bold px-2 py-1 uppercase">
        Subscribe & Save
      </span>
    </div>
    ...
    {/* TEXT */}
    <div>
      <p className="text-3xl font-black text-joe-dark mb-3">
        {p.name}
      </p>

      <p className="text-xl text-joe-mid font-medium">
