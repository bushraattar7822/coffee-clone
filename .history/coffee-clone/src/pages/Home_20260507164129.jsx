...
<section
  ...
  style={{
    ...
    background: `
      ...
      linear-gradient(135deg, #9186bf 0%, #a590c1 42%, #d29aa5 100%)
    `,
  }}
>

  {/* GRAIN / GIBBERISH TEXTURE */}
  <div
    className="absolute inset-0 pointer-events-none opacity-[0.42] mix-blend-overlay"
    style={{
      backgroundImage:
        `url("data:image/svg+xml,%3Csvg viewBox='0 0 240 240' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='n'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.9' numOctaves='4' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23n)' opacity='0.75'/%3E%3C/svg%3E")`,
  ...
  <div
    ...
    style={{
      background: `
        ...
        radial-gradient(circle at 80% 60%, rgba(255,255,255,0.07), transparent 24%),
        radial-gradient(circle at 50% 50%, rgba(0,0,0,0.08), transparent 34%)
      `,
      filter: "blur(50px)",
  ...
  <div
    ...
    style={{
      ...
      top: "18px",
      width: "670px",
      fontFamily: `"Cooper Black", "Arial Rounded MT Bold", serif`,
      fontWeight: 900,
      lineHeight: 0.95,
  ...
  >
    ...
    >
      who grow, harvest, invest, and transform. moving into feminist
      futures within coffee. profound positive change, courage curiosity,
    ...
    <div style={{ marginTop: "22px" }}>
      <Link
        to="/shop"
        className="inline-block border-b border-white text-white hover:opacity-70 transition-opacity"
        style={{
