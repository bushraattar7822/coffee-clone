...
import benchImage from "../assets/bench.webp";
import walkingImage from "../assets/walking.webp";
...
function Marquee() {
  const items = [
    { img: joeLogo, label: "Commitment" },
    { img: benchImage, label: "Community" },
    { img: walkingImage, label: "Curiosity" },
    { img: birdImage, label: "Craft" },
  ];
  const repeated = [...items, ...items, ...items];

  return (
    <div className="overflow-hidden bg-white py-12 border-y border-gray-100">
      <motion.div
      ...
      >
        {repeated.map((item, i) => (
          <div key={i} className="flex items-center gap-8 shrink-0">
            <span className="text-[44px] lg:text-[52px] font-black text-joe-dark tracking-tight leading-none">
              {item.label}
            </span>
            <img
              src={item.img}
    ...
    <section className="px-8 lg:px-16 py-16 bg-white">
      ...
      <div className="relative">
        {start > 0 && (
          <button
            onClick={prev}
            className="absolute -left-5 top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-white border border-gray-200 rounded-full flex items-center justify-center shadow hover:bg-joe-blue hover:text-white transition-all"
          >
            <ChevronLeft size={18} />
          </button>
        )}
        ...
        {start + visible < products.length && (
          <button
            onClick={next}
            className="absolute -right-5 top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-white border border-gray-200 rounded-full flex items-center justify-center shadow hover:bg-joe-blue hover:text-white transition-all"
          >
    ...
    <main>
        ...
        <div className="flex items-center justify-center">
          <div className="text-center">
            <div
              ...
              style={{ fontFamily: "serif", fontSize: "clamp(40px,7vw,90px)" }}
            >
        ...
        {[
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-10">
              ...
              <p className="text-sm text-white/85 font-light leading-relaxed mb-6 max-w-sm">
                {card.desc}
              </p>
              
                href="#"
                className="inline-block bg-joe-blue text-white px-8 py-3 rounded-full text-[11px] font-bold tracking-widest uppercase hover:bg-blue-600 transition-colors self-start"
              >
                {card.cta}
              </a>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_0.7fr] gap-16 items-start">
          ...
          <div className="flex flex-col gap-6">
            {cityCollection.map((p) => (
              <div
                key={p.id}
                className="w-full border border-gray-100 hover:shadow-xl transition-all duration-300 cursor-pointer group bg-white overflow-hidden"
              >
                ...
                <div className="p-4 text-center">
                  <p className="text-xl font-black text-joe-dark mb-2">{p.name}</p>
      ...
      <section className="bg-white">
        ...
        >
          ...
          {/* CENTER TEXT BOX */}
          <div className="bg-gray-50 aspect-square flex flex-col items-center justify-center text-center p-6 col-span-1 lg:col-start-3 lg:row-start-1 lg:row-span-2">
            ...
            <p className="text-sm text-joe-mid mb-6">
              Tag{" "}
              <strong className="text-joe-dark">@joecoffeecompany</strong> in
