...
>
  ...
  <div
    key={p.id}
    className="border border-gray-100 hover:shadow-2xl transition-all duration-300 cursor-pointer group bg-white overflow-hidden"
  >
    {/* IMAGE */}
    <div className="relative w-full h-[320px] bg-joe-blue overflow-hidden">
      <img
        src={p.img}
        alt={p.name}
      ...
      <span className="absolute top-3 left-3 bg-joe-dark text-white text-[10px] font-bold px-2 py-1 uppercase">
        Sold out
      </span>

      <span className="absolute top-12 left-3 bg-joe-blue text-white text-[10px] font-bold px-2 py-1 uppercase">
        Subscribe & Save
      </span>
    </div>
