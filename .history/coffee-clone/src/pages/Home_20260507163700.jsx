...
<section
  ...
  style={{
    background: `
      radial-gradient(circle at 15% 70%, #d98f8a 0%, transparent 32%),
      radial-gradient(circle at 75% 18%, #e58b74 0%, transparent 28%),
      radial-gradient(circle at 50% 30%, rgba(255,255,255,0.08) 0%, transparent 45%),
      linear-gradient(135deg, #8f8bc7 0%, #b18ac4 45%, #d39aa5 100%)
    `,
  }}
>
  ...
  <div
    ...
    style={{
      background:
        ...
        radial-gradient(circle at 80% 60%, rgba(255,255,255,0.08), transparent 25%),
        radial-gradient(circle at 60% 40%, rgba(0,0,0,0.08), transparent 30%)
        `,
      filter: "blur(45px)",
      transform: "scale(1.2)",
    }}
  ...
  {/* CONTENT */}
  <div className="relative z-10 w-full max-w-[1180px] px-6 lg:px-10 -mt-6">
    ...
    <motion.div
      ...
      className="max-w-[860px] mx-auto text-left text-[#f8f2eb]"
    >

      {/* top line */}
      <p
        className="tracking-[-0.05em] leading-[0.92] mb-1"
        style={{
          fontFamily: "'Baloo 2', cursive",
      ...
      {/* headline */}
      <h1
        className="tracking-[-0.08em] leading-[0.8] mb-2"
        style={{
          fontFamily: "'Baloo 2', cursive",
      ...
      >
        ...
        futures within coffee. profound positive change, courage,
        curiosity, and collective power{" "}
        <span className="line-through opacity-55">
      ...
      {/* movement */}
      <div
        className="tracking-[-0.1em] leading-[0.78] mt-1"
        style={{
          fontFamily: "'Baloo 2', cursive",
          fontSize: "clamp(80px, 11vw, 175px)",
          fontWeight: 800,
        }}
      >
        a movement to join
      ...
      <div className="mt-4 text-center">
        <Link
          to="/shop"
          className="inline-block border-b border-[#f8f2eb] text-[#f8f2eb] pb-1 hover:opacity-70 transition-opacity"
          style={{
