  ...
  return (
    <main>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden"
        style={{ background: "linear-gradient(135deg, #c9a0dc 0%, #b784c7 20%, #9b6bb5 40%, #d4a5c9 60%, #e8a598 80%, #d4917a 100%)" }}>
        {/* grain overlay */}
        ...
        <div className="relative z-10 text-center px-8 max-w-4xl">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <div className="text-white font-extrabold leading-none" style={{ fontSize: "clamp(60px, 12vw, 130px)", fontFamily: "serif", letterSpacing: "-2px" }}>
              <div style={{ fontSize: "0.45em", letterSpacing: "0.05em" }}>café</div>
              <div>fëm</div>
              <div>inista</div>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="text-white text-left max-w-2xl mx-auto"
          >
            <p className="text-xl lg:text-2xl mb-2 font-medium">
              <span className="line-through opacity-60">just a coffee</span> a statement of intent.
            </p>
            <p className="text-3xl lg:text-5xl font-extrabold mb-2">leadership by women</p>
            <p className="text-base lg:text-lg font-normal opacity-90 mb-2">
              ...
              <span className="line-through opacity-60">an idea to agree with</span>
            </p>
            <p className="text-3xl lg:text-5xl font-extrabold">a movement to join</p>
          </motion.div>
          ...
          >
            <Link to="/shop"
              className="inline-block border-2 border-white text-white px-10 py-3 text-[11px] font-bold tracking-widest uppercase hover:bg-white hover:text-joe-dark transition-all">
