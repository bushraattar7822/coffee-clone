...
<section
  ...
  style={{
    background: `
      ...
      radial-gradient(circle at 60% 35%, rgba(255,255,255,0.08) 0%, transparent 40%),
...
>
  ...
  {/* CONTENT */}
  <div className="relative z-10 w-full max-w-[1150px] px-6 lg:px-10 -mt-6">
    ...
    >
      <div
        className="text-[#f7f1eb]"
        style={{
          fontFamily: "'Baloo 2', cursive",
          fontSize: "clamp(82px, 11vw, 150px)",
          lineHeight: "0.74",
    ...
    <motion.div
      ...
      className="max-w-[860px] mx-auto text-left text-[#f7f1eb]"
    >

      {/* TOP LINE */}
      <p
        className="leading-[0.94] mb-1 tracking-[-0.05em]"
        style={{
          fontFamily: "'Baloo 2', cursive",
      ...
      {/* MAIN HEADING */}
      <h1
        className="tracking-[-0.07em] leading-[0.82] mb-2"
        style={{
          fontFamily: "'Baloo 2', cursive",
      ...
      {/* DESCRIPTION */}
      <p
        className="max-w-[860px] tracking-[-0.03em]"
        style={{
          fontFamily: "'Baloo 2', cursive",
      ...
      {/* HUGE STATEMENT */}
      <div
        className="tracking-[-0.09em] leading-[0.8] opacity-[0.98] mt-1"
        style={{
          fontFamily: "'Baloo 2', cursive",
          fontSize: "clamp(78px, 11vw, 170px)",
          fontWeight: 800,
        }}
      >
        a movement to join
      ...
      <div className="mt-4 text-center">
        <Link
          to="/shop"
          className="inline-block border-b border-[#f7f1eb] text-[#f7f1eb] pb-1 hover:opacity-70 transition-opacity"
          style={{
