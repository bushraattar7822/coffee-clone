...
const valueSlides = [
...

  {
    ...
    text: "For more than 20 years Joe has gone from a single cafe in the Village to cafes across New York. Along the way we've expanded into catering, wholesale, and tech solutions. Each new step carries the same focus on quality, connection, and hospitality that defines the cafe experience.",
    img: birdImage,
  },
];
