...
export default function Home() {
  return (
    <main>
     ...
     {/* ── FREE SHIPPING BAR ── */}
<section
  className="w-full text-center py-[11px]"
  style={{
    background: "#118ACB",
  }}
>
  <p className="text-white font-extrabold tracking-wide text-[14px]">
...
>
  ...
  {/* CENTER FEMINISTA LOGO */}
  <div className="absolute inset-0 flex flex-col items-center justify-start pt-[58px] z-20">
